...
| **Feature Spec (WHAT)** | `/spec` | `.agent/specs/SPEC-1.0_lms_platform.md` | `.agent/skills/spec/SKILL.md` |
| **Adversarial Audit** | `/challenge` | `.agent/specs/SPEC-1.0_lms_platform.md` | `.agent/skills/challenge/SKILL.md` |
| **Design & Tasks (HOW)**| `/plan` | `.agent/specs/SPEC-1.0_lms_platform.md` | `.agent/skills/plan/SKILL.md` |
| **Diff Execution** | `/build` | `.agent/specs/SPEC-1.0_lms_platform.md` | `.agent/scratchpad.md` |
